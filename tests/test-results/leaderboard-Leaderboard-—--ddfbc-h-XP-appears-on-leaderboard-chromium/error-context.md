...
- Name: leaderboard.spec.ts >> Leaderboard — user visibility and ranking >> user with high XP appears on leaderboard
- Location: tests/e2e/leaderboard.spec.ts:58:7
...
Call log:
  ...
  - waiting for getByText('LBTester')

...
Locator: getByText(/spending simulator/i)
Expected: visible
Error: strict mode violation: getByText(/spending simulator/i) resolved to 2 elements:
    1) <h1 class="mt-2 text-4xl font-extrabold text-[var(--black)]">Spending Simulator</h1> aka locator('h1')
    2) <h2 class="text-2xl font-extrabold text-[var(--black)]">Spending Simulator</h2> aka locator('h2')

Call log:
  - Expect "toBeVisible" with timeout 8000ms
  - waiting for getByText(/spending simulator/i)

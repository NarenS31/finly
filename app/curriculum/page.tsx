...
export default function CurriculumPage() {
  ...
  const ncCurriculum = [
    { code: 'E.1.1', title: 'Types of Economies', file: 'E.1.1.mdx' },
    { code: 'E.1.2', title: 'Market Structures', file: 'E.1.2.mdx' },
    { code: 'E.1.3', title: 'Supply & Demand', file: 'E.1.3.mdx' },
    { code: 'E.1.4', title: 'Incentives & Profits', file: 'E.1.4.mdx' },
    { code: 'E.2.1', title: 'Macroeconomic Indicators', file: 'E.2.1.mdx' },
    { code: 'E.2.2', title: 'Microeconomic Indicators', file: 'E.2.2.mdx' },
    { code: 'E.2.3', title: 'Fiscal & Monetary Policy', file: 'E.2.3.mdx' },
    { code: 'E.2.4', title: 'Economic Organizations', file: 'E.2.4.mdx' },
    { code: 'E.3.1', title: 'Legal Structure & Property Rights', file: 'E.3.1.mdx' },
    { code: 'E.3.2', title: 'Regulation', file: 'E.3.2.mdx' },
    { code: 'E.3.3', title: 'Taxes & Government Services', file: 'E.3.3.mdx' },
    { code: 'E.4.1', title: 'Trade & Interdependence', file: 'E.4.1.mdx' },
    { code: 'E.4.2', title: 'NC in US/World Economy', file: 'E.4.2.mdx' },
    { code: 'IE.1.1', title: 'Education, Income, Career, Lifestyle', file: 'IE.1.1.mdx' },
    { code: 'IE.1.2', title: 'Career/Education Options', file: 'IE.1.2.mdx' },
    { code: 'IE.1.3', title: 'Postsecondary Costs & Income', file: 'IE.1.3.mdx' },
    { code: 'IE.1.4', title: 'Minimizing Education Costs', file: 'IE.1.4.mdx' },
    { code: 'IE.1.5', title: 'Types of Income', file: 'IE.1.5.mdx' },
    { code: 'IE.2.1', title: 'Payroll Deductions', file: 'IE.2.1.mdx' },
    { code: 'IE.2.2', title: 'Types & Purposes of Taxes', file: 'IE.2.2.mdx' },
    { code: 'IE.2.3', title: 'Tax Form Preparation', file: 'IE.2.3.mdx' },
    { code: 'MCM.1.1', title: 'Creating a Spending Plan', file: 'MCM.1.1.mdx' },
    { code: 'MCM.1.2', title: 'Critiquing Plans', file: 'MCM.1.2.mdx' },
    { code: 'MCM.1.3', title: 'Renting, Leasing, Owning', file: 'MCM.1.3.mdx' },
    { code: 'MCM.1.4', title: 'Mortgages', file: 'MCM.1.4.mdx' },
    { code: 'MCM.2.1', title: 'Using Financial Services', file: 'MCM.2.1.mdx' },
    { code: 'MCM.2.2', title: 'Interest & Fees', file: 'MCM.2.2.mdx' },
    { code: 'MCM.2.3', title: 'Payment Methods', file: 'MCM.2.3.mdx' },
    { code: 'MCM.3.1', title: 'Credit Sources', file: 'MCM.3.1.mdx' },
    { code: 'MCM.3.2', title: 'Debt Management', file: 'MCM.3.2.mdx' },
    { code: 'MCM.3.3', title: 'Debt Pros/Cons', file: 'MCM.3.3.mdx' },
    { code: 'MCM.3.4', title: 'Insurance & Estate Planning', file: 'MCM.3.4.mdx' },
    { code: 'FP.1.1', title: 'Investing Strategies', file: 'FP.1.1.mdx' },
    { code: 'FP.1.2', title: 'Factors in Financial Planning', file: 'FP.1.2.mdx' },
    { code: 'FP.1.3', title: 'Philanthropy & Community', file: 'FP.1.3.mdx' },
    { code: 'CC.1.1', title: 'Advertising & Consumer Decisions', file: 'CC.1.1.mdx' },
    { code: 'CC.1.2', title: 'Information for Decisions', file: 'CC.1.2.mdx' },
    { code: 'CC.1.3', title: 'Consumer Impact on Economy', file: 'CC.1.3.mdx' },
    { code: 'CC.2.1', title: 'Consumer Protection Laws', file: 'CC.2.1.mdx' },
    { code: 'CC.2.2', title: 'Fraudulent Practices', file: 'CC.2.2.mdx' },
    { code: 'CC.2.3', title: 'Consumer Self-Protection', file: 'CC.2.3.mdx' },
  ];
          ...
          <table className="min-w-[600px] w-full border text-sm bg-white rounded-xl">
            ...
            <tbody>
              {ncCurriculum.map((mod) => {
                const slug = mod.file.replace(/\.mdx$/, "");
                return (

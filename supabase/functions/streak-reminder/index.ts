...
const SITE = Deno.env.get("NEXT_PUBLIC_SITE_URL") ?? "https://finly.app";
  ...
  for (const p of profiles ?? []) {
    ...
    const res = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        html: `<p>Hi ${p.display_name},</p><p>Your ${p.streak_current}-day learning streak is waiting — a five-minute lesson keeps the flame alive.</p><p><a href="${SITE}/learn">Open Finly</a></p>`,

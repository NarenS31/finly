...
Locator: getByText(/ProfileUser/i)
Expected: visible
Error: strict mode violation: getByText(/ProfileUser/i) resolved to 2 elements:
    1) <h1 class="font-[var(--font-display)] text-4xl font-bold text-[var(--color-text-primary)]">Hi, ProfileUser</h1> aka getByRole('heading', { name: 'Hi, ProfileUser' })
    2) <p class="mt-2 text-base font-semibold text-[var(--green-deeper)]">ProfileUser</p> aka getByText('ProfileUser', { exact: true })

Call log:
  - Expect "toBeVisible" with timeout 8000ms
  - waiting for getByText(/ProfileUser/i)
